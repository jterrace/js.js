...
__twttrlr(function(using, provide, loadrunner, define) {
    ...
    provide("util/tweetparser", function(a) {
        using("util/util", function(b) {
            ...
            function j(a) {
                ...
                i = g("a", a).pop();
                if (f.test(i.href)) return b.name = "", b.screen_name = RegExp.$2, b
            }
            var c = /\/(\d+)\/?$/,
    ...
    provide("tfw/data", function(a) {
        using("util/querystring", function(b) {
            ...
            var c = "twttr.tfw.callbacks",
                d = twttr.tfw.callbacks,
                e = "cb",
                f = 0,
                g = !1,
                h = function(a, b) {
            ...
            n.config = function(a) {
                ...
                var a = "//api.twitter.com/1/users/lookup.json",
                    c = "//cdn.api.twitter.com/1/users/show.json";
                return function() {
                    var d, e = {};
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function(b, c, d, e, f) {
            var g = document.title,
                ...
                j = function(a) {
                    ...
                    var c = this.params(),
                        d = c.count || this.dataAttr("count"),
                        f = c.size || this.dataAttr("size"),
                        j = e.getScreenNameFromPage();
            ...
            j.prototype = new c.Base, b.aug(j.prototype, {
                parameters: function() {
                    var a = {
                        text: this.text,
                        url: this.url,
                ...
                render: function(a) {
                    var b = a.assetUrl() + "/widgets/tweet_button.1334389481.html#" + this.parameters();
                    this.count && (this.originElement.className += " twitter-count-" + this.count), this.element = this.create(b, this.originElement.className, this.dimensions(), {
    ...
    provide("tfw/widget/tweetembed", function(a) {
        using("util/util", "tfw/widget/base", "tfw/widget/tweet", "util/uri", "util/insert", "tfw/data", "i18n/i18n", "util/params", "util/tweetparser", "tfw/widget/tracking", function(b, c, d, e, f, g, h, i, j, k) {
            ...
            var l = "1.0",
                m = i.fromQuery(document.location),
                n, o = /^([0-9]+)( ?px)?$/,
                p = "subject",
                q = "thread",
                u = function(a) {
            ...
            u.prototype = new c.Base, b.aug(u.prototype, {
                create: function(a, b) {
                    var c = this,
    ...
    provide("tfw/widget/follow", function(a) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function(b, c, d, e, f) {
            var g = function(a) {
                    ...
                    var b = this.params(),
                        c = b.size || this.dataAttr("size"),
                        d = b.show_screen_name || this.dataAttr("show-screen-name"),
                        e = b.show_count || this.dataAttr("show-count");
            ...
            g.prototype = new c.Base, b.aug(g.prototype, {
                ...
                render: function(a) {
                    ...
                    var b = a.assetUrl() + "/widgets/follow_button.1334389481.html#" + this.parameters();
                    this.element = this.create(b, "twitter-follow-button", this.dimensions(), {
                ...
                width: function() {
                    ...
                    var a = {
                        ...
                        g = this._("%{followers_count} followers", {
    ...
    function() {
        ...
        twttr.init = !0, !
        function() {
            twttr._e = twttr._e || [], twttr.ready = twttr.ready ||
            function(a) {
                twttr.widgets && twttr.widgets.loaded ? a(twttr) : twttr._e.push(a)
            }
        }(), using.path.length || (using.path = "//" + twttr.host + "/js"), twttr.ignoreSSL = twttr.ignoreSSL || !1;
        var b = [];
        twttr.events = {
            bind: function(a, c) {
                return b.push([a, c])
            ...
            c(function() {
                using("util/util", "tfw/widget/follow", "tfw/widget/tweet", "tfw/widget/tweetembed", "tfw/widget/intent", "util/events", "tfw/widget/base", function(c, d, e, f, g, h, i) {
                    ...
                    var j = {
                        ...
                        k = twttr.events && twttr.events.hub ? twttr.events : {};
